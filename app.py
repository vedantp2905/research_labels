...
def main():
    ...
    # Instructions section with better formatting and clarity
    st.markdown("""
    ### Instructions
    
    #### Overview
    This tool compares labels generated by GPT-4o and CodeConceptNet-V1 for code token clusters.
    
    #### Evaluation Process
    1. **Batch Assignment**
        - Choose a batch of 50-100 clusters to evaluate
        - Contact Vedant before starting to avoid overlap with other evaluators
        - Use the "Jump to cluster" box to go to your assigned batch
    
    2. **What to Evaluate**
        - **Syntactic Function**: Compare GPT-4o and V1 labels based on the syntactic role of tokens in the code
        - **Semantic Understanding**: Compare semantic tags to assess how well each model understands the code's meaning
        - **Notes**: Provide brief justification for your evaluation of each cluster
    
    3. **Evaluation Criteria**
        - Acceptability: Is the GPT-4o label acceptable?
        - Precision: How precise is GPT-4o compared to V1?
        - Quality: Is GPT-4o's label better than V1's?
    
    #### Important Notes
    - Total clusters to evaluate: 500
    - Work in batches of 50-100 clusters
    - Report any bugs or issues to Vedant
    - Avoid concurrent evaluations of the same clusters
    """)
